    ...
    return {
      skills: [
...

        {
          name: 'Laravel',
          icon:
            'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Laravel.svg/231px-Laravel.svg.png',
        },
        // {
        //   name: 'Express',
        //   icon: '',
        ...
        },
        {
          name: 'Postgres',
          icon:
            'https://wiki.postgresql.org/images/thumb/a/a4/PostgreSQL_logo.3colors.svg/116px-PostgreSQL_logo.3colors.svg.png',
        },
        {
          name: 'MySQL',
